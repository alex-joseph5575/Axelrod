...
strategies = [s for s in all_strategies if Classifiers.obey_axelrod_evo(s())]
...
cheating_strategies = [
    s for s in all_strategies if not Classifiers.obey_axelrod_evo(s())
]
